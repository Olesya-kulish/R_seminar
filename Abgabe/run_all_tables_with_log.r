...
# Runs each script in a new environment to avoid side effects, and captures success/failure and timing information for logging. 
# Results are collected into a data frame and saved as CSV.
